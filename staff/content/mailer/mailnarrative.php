...
//get the character narratives from the database and loop through them
$sql = "SELECT n.*, c.*, p.* FROM `character_narratives` n JOIN `character` c on n.char_id = c.id JOIN players p on p.id = c.player_id WHERE game_number = " . $game_number;

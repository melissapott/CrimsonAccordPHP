...
<html lang="en">
	...
	<body>
		<div class="container">
			...
			<nav class="navbar navbar-default col-md-12">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="/news/archives.php">Full Archives</a></li>
			...
			<!-- we need an iFrame to display the PDF file inline -->
			<div class="col-md-8 embed-responsive" style="padding-bottom:150%">
				<iframe src="shownews.php?id=<?php echo $_GET['id']; ?>" frameborder="0" align="center" width="100%" height="100%" scrolling="no"></iframe>
			</div>
			<div class="col-md-4">
				<?php newspaperSidebar($mysqli); ?>
			</div>
		</div>
	</body>
</html>